...
class LoanedBookInstanceByUserListViewTest(TestCase):
    ...
    #Create a book
        ...
        test__book = Book.objects.create(
            title='Book Title',
    ...
    def test_logged_in_uses_correct_template(self):
        ...
        self.assertTemplateUser(response, 'catalog/bookinstance_list_borrowed_user.html')
    ...
    def test_only_borrowed_books_in_list(self):
        ...
        for bookitem in response.conntext['bookinstance_list']:
            self.assertEqual(response.context['user'], bookitem.borrower)
            self.assetEqual('o', bookitem.status)
...
class RenewBookInstancesViewTest(TestCase):
    ...
    def test_redirect_if_logged_in_but_not_correct_permission(self):
        ...
        # Check that it lets us login - this is our book and have the right permissions.
        self.assertEqual(response.status_code, 403)
    ...
    def test_uses_correct_template(self):
        ...
        self.assertEqual(response.comtext['form'].initial['renwal_date'], date_3_weeks_in_future)

        # Check we used corredt template
